...
ggplot(data = error, aes(x=k.neighbor, y = k.accuracy)) +
  ...
  labs(title = 'Number of Neighbors vs. KNN Accuracy',
       ...
       y = 'Accuracy Rate') +
  theme_bw()
ggsave('./plots/num_neighbors/continous_KNN.jpg')
...
ggplot(data = error, aes(x=k.neighbor, y = k.accuracy)) +
  ...
  labs(title = 'Number of Neighbors vs. KNN Accuracy',
       ...
       y = 'Accuracy Rate') +
  theme_bw()
ggsave('./plots/num_neighbors/all_KNN.jpg')
...
ggplot(data = error, aes(x=k.neighbor, y = k.accuracy)) +
  ...
  labs(title = 'Number of Neighbors vs. KNN Accuracy',
       ...
       y = 'Accuracy Rate') +
  theme_bw()
ggsave('./plots/num_neighbors/pca_KNN.jpg')
...
ggplot(data = error, aes(x=k.neighbor, y = k.accuracy)) +
  ...
  geom_line(color = 'dodgerblue3') + 
  labs(title = 'Number of Neighbors vs. KNN Accuracy',
       subtitle = 'Principal component analysis of continuous wetland predictors',
       x = 'Number of Neighbors',
       y = 'Accuracy Rate') +
  theme_bw() +
...
ggplot(data = knn.cont.labels, aes(x = class, fill = source)) +
  ...
  theme_bw() +
  guides(fill=guide_legend(""))
ggsave('./plots/predictions/continous_predictions.jpg')
...
ggplot(data = knn.all.labels, aes(x = class, fill = source)) +
  ...
  theme_bw() +
  guides(fill=guide_legend(""))
ggsave('./plots/predictions/all_predictions.jpg')
...
ggplot(data = knn.pca.labels, aes(x = class, fill = source)) +
  ...
  labs(title = "Actual vs. Predicted Classifications",
       ...
       y = 'Classification Count') +
  theme_bw()
ggsave('./plots/predictions/pca_predictions.jpg')
